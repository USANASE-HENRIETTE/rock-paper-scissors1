...
let computerSelection = [{choice: 'Rock', value: 0}, {choice: 'Paper', value: 1}, {choice: 'Scissors', value: 2}];
let playerScore = 0;
let compScore = 0;
let playerChoice;

function computerSelection () {
  let result = computerSelection[Math.floor(Math.random() * computerSelection.length)];
  return result;
}
